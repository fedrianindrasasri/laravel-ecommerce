...
<body>
    ...
    <header class="header_area">
        <div class="top_menu rowm0">
            <div class="container-fluid">
                <div class="float-left">
                    <p>Call Us: 0123 2222 2222 2222</p>
                </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    <a href="{{ url('/')}}" class="navbar-brand logo_h">
                ...
                <div class="col-lg-6">
                    <div class="mc_embed_signup">
                        <form target="_blank" novalidate
                            ...
                            <button type="submit" class="news1-btn">Get Started</button>
                            <div class="info"></div>
                        </form>
                    </div>
                </div>
