                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product_count">
                                        <!--Perhatikan bagian ini namenya kita buat array, agar bisa menyimpan lebih dari 1 data-->
                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner">
                                        <a href="{{ route('front.product') }}" class="gray_btn">Continue Shopping</a>
                                        <a href="{{ route('front.checkout') }}" class="main_btn">Processed to
                                            Checkout</a>
                                    </div>
                                </td>
                            </tr>
